(function () {
    ...
    function showCOVID19Notice() {
        ...
        '<div class="closed-notice" style="font-size: 16px">The Libraries are only open to BC students and employees and with <a href="https://library.bc.edu/hours">limited hours</a>. Burns Library is also open to <a href="https://libguides.bc.edu/burns/services/covid19access">visiting researchers</a> by appointment only.' +
        '</div>' +
